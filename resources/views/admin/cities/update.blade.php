            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">تعديل مدينة</span>
                    </div>
                </div>
                <div class="portlet-body">

                    {!! Form::open(['url'=>'city/'.$city->id,'method'=>'put','class'=>'form-horizontal']) !!}
                    <div class="form-body">
                        <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="city" value="{{ $city->city }}" class="form-control" placeholder="ادخل المدينة ...">
                                </div>
                                @if ($errors->has('city'))
                        ...
                        <div class="form-group{{ $errors->has('cost') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    ...
                                    <input type="number" value="{{ $city->cost }}" name="cost" class="form-control" placeholder="ادخل التكلفة ...">
                                </div>
                                @if ($errors->has('cost'))
                                    <span class="help-block help-block-error">
