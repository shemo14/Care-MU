            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">تعديل سرير {{ $bed->id }}</span>
                    </div>
                </div>
                <div class="portlet-body">

                    {!! Form::open(['url'=>'beds/'.$bed->id,'method'=>'put','class'=>'form-horizontal', 'files'=>'true']) !!}
                    <div class="form-body">
                        <div class="form-group{{ $errors->has('number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="number" value="{{ $bed->number }}" class="form-control" placeholder="رقم السرير ...">
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('care') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" style="width: 100%">
                                    {!! Form::select('care',$care,$bed->care,['class'=>'form-control','id'=>'select']) !!}
                                </div>
                                @if ($errors->has('care'))
                                    <span class="help-block help-block-error">
