            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">تعديل {{ $news->title }}</span>
                    </div>
                </div>
                <div class="portlet-body">

                    {!! Form::open(['url'=>'news/'.$news->n_id,'method'=>'put','class'=>'form-horizontal', 'files'=>'true']) !!}
                    <div class="form-body">
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input value="{{ $news->title }}" type="text" name="title" class="form-control" placeholder="العنوان ...">
                                </div>
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <textarea class="ckeditor form-control" name="desc" id="" rows="6" data-error-container="#editor2_error">{!! $news->desc !!}</textarea>
                                </div>
                                @if ($errors->has('desc'))
                                    <span class="help-block help-block-error">
                        ...
                        <div class="form-group{{ $errors->has('photo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <img id="blah" class="img-thumbnail" style="height: 350px;width: 100%;" src="{{ Request::root() }}/{{ $news->path }}{{ $news->fileName }}" alt="">
