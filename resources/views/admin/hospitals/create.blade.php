            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">اضافة مستشفى جديدة</span>
                    </div>
                </div>
                <div class="portlet-body">

                    {!! Form::open(['url'=>'hospital','method'=>'post','class'=>'form-horizontal', 'files'=>'true']) !!}
                    {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="اسم المستشفى ...">
                                </div>
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" style="width: 100%">
                                    ...
                                    <textarea class="form-control" name="address" id="" placeholder="عنوان المستشفى ..." rows="6"></textarea>
                                </div>
