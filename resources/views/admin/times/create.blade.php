            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">اضافة لمواعيد التوصيل</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <!-- BEGIN FORM-->

                    {!! Form::open(['url'=>'time','method'=>'post','class'=>'form-horizontal']) !!}
                    <div class="form-body">
