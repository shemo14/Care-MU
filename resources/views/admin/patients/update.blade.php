            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">تعديل المريض {{ $patient->name }}</span>
                    </div>
                </div>
                <div class="portlet-body">

                    {!! Form::open(['url'=>'patients/'.$patient->id,'method'=>'put','class'=>'form-horizontal', 'files'=>'true']) !!}
                    <div class="form-body">
                        ...
                        <div class="form-group{{ $errors->has('nat_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nat_id" class="form-control" value="{{ $patient->nat_id }}" placeholder="الرقم القومي ...">
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('care') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" style="width: 100%">
                                    {!! Form::select('care',$care,$patient->care,['class'=>'form-control']) !!}
                                </div>
                                @if ($errors->has('care'))
                                    <span class="help-block help-block-error">
                        ...
                        <div class="form-group{{ $errors->has('bed') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" style="width: 100%">
                                    {!! Form::select('bed',$bed,$patient->bed,['class'=>'form-control','id'=>'select']) !!}
                                </div>
                                @if ($errors->has('bed'))
                                    <span class="help-block help-block-error">
