        ...
        <div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        <a href="index.html">
                            <img src="{{ Request::root() }}/admin/logo.png" style="height: 46px;margin: 0;" alt="logo" class="logo-default" /> </a>
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    {{--<img alt="" class="img-circle" src="{{ Request::root() }}/admin/layouts/layout/img/avatar3_small.jpg" />--}}
                                ...
                                <ul class="dropdown-menu dropdown-menu-default">
                                    <li>
                                        <a href="{{ url('account') }}">
                                            <i class="fa fa-cogs"></i>اعدادات الحساب</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('logout') }}">
